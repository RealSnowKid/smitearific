...
// String str = restTemplate.getForObject("http://localhost:8081/godinfoes",
// String.class);
// JSONObject jObject = new JSONObject(str);
// JSONArray jArray =
// jObject.getJSONObject("_embedded").getJSONArray("godinfoes");
...
// jobj.put("ability1Description",
// jo.getJSONObject("Ability_1").getJSONObject("Description")
...
// jobj.put("ability2Description",
// jo.getJSONObject("Ability_2").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("description"));
// jobj.put("ability2Cooldown",
// StringUtils.replace(jo.getJSONObject("Ability_2").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("cooldown"), "s",
// " seconds"));
// jobj.put("ability2Cost",
// jo.getJSONObject("Ability_2").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("cost") + " mana");
// jobj.put("ability2Menuitems",
// jo.getJSONObject("Ability_2").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("menuitems").toString());
// jobj.put("ability2Rankitems",
// jo.getJSONObject("Ability_2").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("rankitems").toString());
...
// jobj.put("ability3Description",
// jo.getJSONObject("Ability_3").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("description"));
// jobj.put("ability3Cooldown",
// StringUtils.replace(jo.getJSONObject("Ability_3").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("cooldown"), "s",
// " seconds"));
// jobj.put("ability3Cost",
// jo.getJSONObject("Ability_3").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("cost") + " mana");
// jobj.put("ability3Menuitems",
// jo.getJSONObject("Ability_3").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("menuitems").toString());
// jobj.put("ability3Rankitems",
// jo.getJSONObject("Ability_3").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("rankitems").toString());
...
// jobj.put("ability4Description",
// jo.getJSONObject("Ability_4").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("description"));
// jobj.put("ability4Cooldown",
// StringUtils.replace(jo.getJSONObject("Ability_4").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("cooldown"), "s",
// " seconds"));
// jobj.put("ability4Cost",
// jo.getJSONObject("Ability_4").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("cost") + " mana");
// jobj.put("ability4Menuitems",
// jo.getJSONObject("Ability_4").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("menuitems").toString());
// jobj.put("ability4Rankitems",
// jo.getJSONObject("Ability_4").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("rankitems").toString());
...
// jobj.put("ability5Description",
// jo.getJSONObject("Ability_5").getJSONObject("Description")
// .getJSONObject("itemDescription").getString("description"));
// jobj.put("ability5Menuitems",
// jo.getJSONObject("Ability_5").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("menuitems").toString());
// jobj.put("ability5Rankitems",
// jo.getJSONObject("Ability_5").getJSONObject("Description")
// .getJSONObject("itemDescription").getJSONArray("rankitems").toString());
// RestTemplate restTemplate = new RestTemplate();
...
// HttpEntity<String> request = new HttpEntity<String>(jobj.toString(),
// headers);

// godinfo godinfo =
// restTemplate.postForObject("http://localhost:8081/godinfoes", request,
// godinfo.class);
...
// String string = restTemplate.getForObject("http://localhost:8081/godinfoes/",
// String.class);
// JSONArray jArray = new
// JSONObject(string).getJSONObject("_embedded").getJSONArray("godinfoes");
...
// try {
// str =
// restTemplate.getForObject("http://localhost:8081/godinfoes/search/resetAutoIncrement",
// String.class);
...
// private static void hiRezAPICall() throws NoSuchAlgorithmException,
...
// String hiRezApString =
// "http://api.smitegame.com/smiteapi.svc/createsessionjson/" + devId + "/"
...
// System.out.println("Return message: " + jo.getString("ret_msg") + " Session
// ID: "
...
// private static void getGodsCall() throws NoSuchAlgorithmException,
// UnsupportedEncodingException {
// hiRezAPICall();
...
// String hiRezApString = "http://api.smitegame.com/smiteapi.svc/getgodsjson/" +
// devId + "/" + signature
// + "/" + session + "/" + timestamp + "/1";
// System.out.println(hiRezApString);
